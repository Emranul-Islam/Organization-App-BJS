...
import xyz.emranul.bijos.adapter.BloodAdapter;
...
public class BloodMemberActivity extends AppCompatActivity {
    ...
    private final FirebaseFirestore base = FirebaseFirestore.getInstance();
    private final CollectionReference ref = base.collection("blood");
    private Query query;
