...
import xyz.emranul.bijos.adapter.ChadaAdapter;
...
public class UserActivity extends AppCompatActivity {
    ...
    private final DocumentReference dataRef = firebase.collection("Sodesso_List").document(UID);
    private final CollectionReference chadaRef = firebase.collection("Sodesso_List").document(UID).collection("Chada_2020");
